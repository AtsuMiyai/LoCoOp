...
- 2. When testing other than ImageNet OOD Benchmark, **change the value of the training "-topk" and "-lambda" argument and report the value in the paper.** The current config is for ImageNet-1K.
...
1. [![](https://img.shields.io/badge/IJCV'23-PEFTMCM-blue)](https://link.springer.com/article/10.1007/s11263-023-01895-7), [code](https://github.com/deeplearning-wisc/MCM)
    > This paper proposes PEFT-MCM, demonstrating the effectiveness of combining parameter-efficient tuning methods and MCM.
